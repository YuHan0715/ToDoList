//
//  TaskFilterCollectionViewCell.swift
//  Task
//
...
class TaskFilterCollectionViewCell: UICollectionViewCell {
    ...
    func binding(_ viewModel: TaskFilterCollectionViewCellViewModel) {
